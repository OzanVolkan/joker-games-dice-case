...
public class AudioManager : MonoBehaviour
{
    ...
    [Header("Audio Clips")] 
    [SerializeField] private AudioClip _peonMovement;
    ...
    [SerializeField] private float _pitchIncrement = 0.1f;
    [SerializeField] private float _maxPitch = 2.0f;
    [SerializeField] private float _pitchResetDelay = 2.0f; // Pitch'in normal değere döneceği süre

    private float _defaultPitch = 1.0f; // Başlangıç pitch değeri
    ...
    {
        _effectAudioSource.pitch = Mathf.Clamp(_effectAudioSource.pitch + _pitchIncrement, _defaultPitch, _maxPitch);
